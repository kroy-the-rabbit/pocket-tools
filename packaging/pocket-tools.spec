...
if sys.platform == "darwin":
    ...
    app = BUNDLE(
        exe,
        name="Pocket Tools.app",
        icon=ICON,
        # Unchanged by the rename. A bundle identifier is the app's
        # identity to macOS, and changing it makes an update read as a
        # different application.
        bundle_identifier="io.kroy.pocket-cheats",
        info_plist={
            "CFBundleName": "Pocket Tools",
            "CFBundleDisplayName": "Pocket Tools",
            ...
            "NSRemovableVolumesUsageDescription":
                "Pocket Tools reads and writes cheat files on your Analogue "
                "Pocket SD card.",
        },
    )
